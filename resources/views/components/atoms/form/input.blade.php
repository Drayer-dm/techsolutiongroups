...
<input
    ...
    @if($required)
        required
    @endif
    {{ $attributes->merge(['class' => 'w-full rounded-md border px-4 py-2 text-sm text-slate-800 placeholder:text-slate-400 transition-colors focus:outline-none focus:ring focus:ring-2 focus:ring-[#10243e]/30 focus:border-[#10243e] ' 
