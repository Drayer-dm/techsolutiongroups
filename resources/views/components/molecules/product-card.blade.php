...
<div class="bg-white dark:bg-slate-900 rounded-lg shadow-sm border border-slate-100 dark:border-slate-700 overflow-hidden flex flex-col">
    ...
    <div class="p-4 flex flex-col flex-1">
        ...
        <p class="font-semibold text-slate-800 dark:text-slate-200 mb-3">${{ number_format($producto['precio'], 0, ',', '.') }}</p>
